  ...
  <div class="popular-view">
    <div class="container my-4">
      ...
      <div class="page-header mb-4">
        ...
        <p class="text-muted">Les séries les plus regardées en ce moment</p>
      </div>
...
const loadSeries = async (pageNum = 1) => {
  ...
  try {
    const response = await serieService.getPopular(pageNum, 20);
    ...
    console.error('Erreur popular:', err);
  } finally {
    loading.value = false;
